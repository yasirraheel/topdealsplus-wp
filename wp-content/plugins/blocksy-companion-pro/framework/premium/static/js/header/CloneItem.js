		...
		<Fragment>
			{hasClone && (
				<span
					...
					<svg width="11px" height="11px" viewBox="0 0 24 24" fill="currentColor">
					...
					<i className="ct-tooltip">{__('Clone Item', 'blocksy-companion')}</i>
				</span>
			)}
			...
			{hasRemove && (
				<span
					...
					<i className="ct-tooltip">{__('Remove Item', 'blocksy-companion')}</i>
				</span>
			)}
		</Fragment>
	)
